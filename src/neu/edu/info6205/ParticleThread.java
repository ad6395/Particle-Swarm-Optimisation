...
//        ArrayList<Main.Particle> particles = Main.particles;
//        MainJFrame mj = Main.mj;
//        
//        
//               
//        // Create dataset                    
...
//        
//    
//        for(Main.Particle p : particles){
//            
//         series1.add(p.getData(0), 1);
//            series2.add(p.getData(1), 3);
//            series3.add(p.getData(2),5);
//            series4.add(Main.particles.get(Main.gBest).getData(0),2);
//            series5.add(Main.particles.get(Main.gBest).getData(1),4);
//            series6.add(Main.particles.get(Main.gBest).getData(2),6);
//
//                
//                        
//        }
